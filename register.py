...
class Register(object):
    ...
    def register(self, phone_no, password,  digits):
    ...
    def upload_avatar(self, token, avatar):
        ...
        files = {
            'picture': ("image.jpeg", open('./avatars/'+avatar, 'rb'), 'image/jpeg')
        }
            ...
            if self.validate(phone_no):
                ...
                if self.send_message(phone_no):
                    ...
                    if digits != None:
                        ...
                        if self.register(phone_no, password,  digits):
